export default function Pricing() {
    return (
        <section
            className="relative flex items-center justify-center pt-20 pb-10 lg:pt-32 lg:pb-16 min-h-[600px] w-full bg-[url('/src/assets/green_garden_course_light.png')] dark:bg-[url('/src/assets/green_garden_course.png')] bg-cover bg-center bg-no-repeat overflow-hidden"
            id="pricing"
        >
            ...
            <div className="container mx-auto px-6 relative z-10">
                <h2 className="text-4xl lg:text-6xl font-info text-center mb-16 text-brand-dark dark:text-brand-cream">
                    Guest Information
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 max-w-7xl mx-auto mb-20 lg:mb-32">
                    <div className="flex flex-col items-center text-brand-dark dark:text-brand-cream text-center">
                        <h3 className="text-2xl lg:text-3xl font-info mb-6 border-b border-brand-dark/20 dark:border-brand-cream/20 w-full pb-3">Off Peak</h3>
                    ...
                    <div className="flex flex-col items-center text-brand-dark dark:text-brand-cream text-center">
                        <h3 className="text-2xl lg:text-3xl font-info mb-6 border-b border-brand-dark/20 dark:border-brand-cream/20 w-full pb-3">Peak</h3>
                        <p className="text-xl lg:text-2xl font-main">Mon–Thu</p>
                    ...
                    <div className="flex flex-col items-center text-brand-dark dark:text-brand-cream text-center">
                        <h3 className="text-2xl lg:text-3xl font-info mb-6 border-b border-brand-dark/20 dark:border-brand-cream/20 w-full pb-3">Weekend</h3>
                    ...
                    <div className="flex flex-col items-center text-brand-dark dark:text-brand-cream text-center">
                        <h3 className="text-2xl lg:text-3xl font-info mb-6 border-b border-brand-dark/20 dark:border-brand-cream/20 w-full pb-3">Extras</h3>
