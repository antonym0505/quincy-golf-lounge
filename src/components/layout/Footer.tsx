...
export default function Footer() {
    return (
        <footer className="w-full py-12 text-brand-cream bg-[#1A2E1E]">
            <div className="container px-12 w-fit">
                {/* Info Section */}
                <div className="flex flex-col md:flex-row gap-12 md:gap-16 text-left">
                    <div className="flex-shrink-0 h-full md:shadow-info">
                        <img src={Logo} alt="Quincy Golf Lounge" className="h-full w-auto" />
                    </div>
                    {/* Contact */}
                    <div>
                        <h4 className="font-info text-xl mb-2 uppercase tracking-wider">Contact</h4>
                    ...
                    {/* Hours */}
                    <div>
                        <h4 className="font-info text-xl mb-2 uppercase tracking-wider">Hours</h4>
                        <p className="font-main">
                            9am – 10pm
                        </p>
                        <p className="font-main">
